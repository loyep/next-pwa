...
export const generateOGImage = async (
  ...
  const notoSansMono = await fs.readFile(path.join(__dirname, "../shared/notoSansMono.ttf"));
  ...
  return new ImageResponse(
    ...
    >
      ...
      <h3 tw="text-lg font-bold leading-7 md:text-xl md:tracking-tight">{DOCS_DOMAIN}</h3>
    </div>,
    {
      ...size,
      fonts: [
