...
const baseTextBoxClassName = clsx(
  ...
  "contrast-more:border contrast-more:text-gray-900 contrast-more:dark:text-gray-50 contrast-more:border-transparent",
  "contrast-more:hover:border-gray-900 contrast-more:dark:hover:border-gray-50"
);
const hoverTextBoxClassName =
  "hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-neutral-800 dark:hover:text-gray-50";
